...
* i nodi del cluster possono fallire


## Ecosistema Hadoop
Hadoop è stato rilasciato dalla Apache Software Foundation nel 2011.
Da allora si sviluppato attorno alla piattaforma un vero e proprio *ecosistema di tecnologie per Big Data*.
...
* il numero di Reducer è impostato sperimentalmente dal programmatore.
...
Un servizio simile è offerto anche da Google Cloud Platform.
...
* modello di programmazione risulta rigido se usato per applicazioni multi-stage complesse (e.g. graph analysis e machine learning).
...
* lentezza nello sart-up e clean-up dei job MapReduce
