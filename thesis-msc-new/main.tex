...
\title{High Performance Computing on AWS}
...
%% If you want to use "double spacing", you should start here...
 ...
 \include{sec/chapter-2-aws-parallelcluster}
 \include{sec/chapter-3-osu-benchmarks}
 \include{sec/chapter-4-amg-solvers}
 \include{sec/chapter-5-experiments}
 \include{sec/chapter-6-conclusions}
