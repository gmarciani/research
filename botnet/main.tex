...
\externaldocument{sec/botnet-architecture}
\externaldocument{sec/bot-fsa}
\externaldocument{sec/bot-loop}
\externaldocument{sec/bot-commands}
\externaldocument{sec/host-analysis}
\externaldocument{sec/bot-configuration}
\externaldocument{sec/bot-implementation}
\externaldocument{sec/cc-implementation}
\externaldocument{sec/usage}
\externaldocument{sec/sample-executions}
...
\input{sec/botnet-architecture}
\input{sec/bot-fsa}
\input{sec/bot-loop}
\input{sec/bot-commands}
\input{sec/host-analysis}
\input{sec/bot-configuration}
\input{sec/bot-implementation}
\input{sec/cc-implementation}
\input{sec/usage}
\input{sec/sample-executions}
