...
\begin{description}
  ...
  Errors in this state are considered fatal, so they would cause bot termination.
  ...
  Errors in this state are considered warning: they are handled and never cause bot termination.
  ...
  In this state errors are considered warning: they are handled and never cause bot termination.
