...
\acmformat{Giacomo Marciani. 2017. Performance Modeling of Computer Systems and Networks.}
...
\input{sec/queueing-theory}
\input{sec/operational-laws}
\input{sec/asymptotic-analysis}
\input{sec/modification-analysis}
\input{sec/exponential-distribution}
\input{sec/poisson-processes}
\input{sec/markov-chains}
\input{sec/server-farms}
\input{sec/m-m-1-queues}
\input{sec/m-m-m-m-queues}
\input{sec/m-m-m-queues}
\input{sec/m-m-inf-queues}
\input{sec/m-g-1-queues}
\input{sec/m-m-1-ps-queues}
\input{sec/capacity-provisioning}
\input{sec/burke-theorem}
\input{sec/networks-of-queues}
\input{sec/open-jackson-networks}
\input{sec/closed-jackson-networks}
\input{sec/mean-value-analysis}
\input{sec/task-assignment-policies-server-farms}
\input{sec/scheduling-m-g-1}
\input{sec/scheduling-non-preemptive-non-size-based}
\input{sec/scheduling-preemptive-non-size-based}
\input{sec/scheduling-non-preemptive-size-based}
\input{sec/scheduling-preemptive-size-based}
\input{sec/random-variables-simulation}
\input{sec/formulary-probability}
\input{sec/formulary-queueing-theory}
